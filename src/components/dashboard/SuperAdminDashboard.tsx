...
import { Shield, Crown, Users, Database, Settings, Activity, AlertTriangle, TrendingUp, ArrowUpRight, Server } from 'lucide-react';
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className={`px-2 py-1 text-xs rounded-full border ${getPriorityBadge(action.priority)}`}>
                              {action.priority}
                            </span>
                          </div>
